    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/abdul-qadir12324/physical-AI-humanoid-robotics-book/tree/main/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/abdul-qadir12324/physical-AI-humanoid-robotics-book',
          label: 'GitHub',
          position: 'right',
        },
      ],
